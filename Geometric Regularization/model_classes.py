...
class LeNet(nn.Module):
    """
    LeNet model architecture for MNIST/CIFAR10 classification with optional
...
class ResNet18(nn.Module):
    """
    ResNet18 model architecture for classification with optional
    ...
    def __init__(
        ...
        if dataset == "CIFAR100":
            ...
            self.model.fc = nn.Linear(
                self.model.fc.in_features, 10
            )  # Adapting for CIFAR10/MNIST
