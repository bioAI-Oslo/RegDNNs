...
*This is an ongoing part of the project, so notes here might be messy.*
...
#### Adverserial Attacks
To further investigate the robustness of the models, I want to implement adverserial attacks and see how the different regularizers effect how the models do against them. In Hoffman 2019 they apply FGSM, PGD and Carlini-Wagner attacks to their models. I start by implementing these.

Untill now I have implemented a white-box untargeted fast gradient sign method (FGSM) attack as in Hoffman 2019 (for FGSM, see Goodfellow et al, 2014).
