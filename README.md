...
#### Adverserial Attacks
To further investigate the robustness of the models, I want to implement adverserial attacks and see how the different regularizers effect how the models do against them.  
