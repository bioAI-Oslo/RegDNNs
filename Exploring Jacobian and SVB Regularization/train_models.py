...
if __name__ == "__main__":
    ...
    if isinstance(model, torch.nn.DataParallel):
        torch.save(model.module.state_dict(), "./trained_models/model_l2_no_dropout.pt")
    else:
        torch.save(model.state_dict(), "./trained_models/model_l2_no_dropout.pt")
    ...
    with open("./trained_models/model_l2_no_dropout_data.pkl", "wb") as f:
        pickle.dump(data, f)
