...
if __name__ == "__main__":
    ...
    if isinstance(model, torch.nn.DataParallel):
        torch.save(model.module.state_dict(), "./trained_mnist_models/model_l2.pt")
    else:
        torch.save(model.state_dict(), "./trained_mnist_models/model_l2.pt")
    ...
    with open("./trained_mnist_models/model_l2_data.pkl", "wb") as f:
        pickle.dump(data, f)
