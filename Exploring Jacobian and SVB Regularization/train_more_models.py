...
if __name__ == "__main__":
    ...
    models = {
        "model_no_reg_3": ResNet18(lr=0.01),
        "model_l2_3": ResNet18(lr=0.01, l2_lmbd=0.0005),
        "model_jacobi_3": ResNet18(lr=0.01, jacobi=True),
        "model_svb_3": ResNet18(lr=0.01, svb=True),
        "model_no_reg_4": ResNet18(lr=0.01),
        "model_l2_4": ResNet18(lr=0.01, l2_lmbd=0.0005),
        "model_jacobi_4": ResNet18(lr=0.01, jacobi=True),
        "model_svb_4": ResNet18(lr=0.01, svb=True),
    }
